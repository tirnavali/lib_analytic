...
ActiveRecord::Schema.define(version: 2021_02_08_195655) do
  ...
  create_table "journal_doc_analytics", force: :cascade do |t|
    ...
    t.integer "JournalDocReport_id", null: false
    t.index ["JournalDocReport_id"], name: "index_journal_doc_analytics_on_JournalDocReport_id"
